<template>
  <div class="flex items-center bg-gray-100">
    <nav class="text-sm sm:text-base bg-white p-2 lg:p-4 rounded-md shadow-lg">
      <ol class="flex list-none p-0 inline-flex">
            ...
            <div class="sm:col-span-4">
              ...
              <div class="flex flex-col gap-2">
                <label v-for="option in fieldOptions" :key="option.value"
                  ...
                  <input type="checkbox" class="form-checkbox accent-blue-600" :value="option.value"
                    :checked="selectedFields.includes(option.value)" @change="() => toggleFieldChoice(option.value)" />
...
async function createVerificationRequest(): Promise<void> {
  ...
  ({ verificationId: verificationId.value, verificationURL: verificationURL.value } = await createSwiyuVerification(selectedFields.value));
