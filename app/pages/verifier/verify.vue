    ...
    <nav class="text-sm sm:text-base bg-white p-2 md:p-2 lg:p-4 rounded-md shadow-lg">
      <ol class="list-none p-0 inline-flex">
        <li class="flex items-center">
          <svg onclick="window.location.href='/verifier';" xmlns="http://www.w3.org/2000/svg" height="1em"
  ...
  <div class="flex mt-14 shadow-md min-h-[500px] shadow-md rounded-xl bg-gray-50">
    <div class="flex-1 mt-10 ml-10">
      <div v-if="step === Step.CONNECTION_SETUP" class="flex items-center justify-center gap-x-6">
        <button type="button" @click="generateQRCodeForConnection"
      ...
      <VerifierIndyWalletCredentialRequest v-if="step === Step.REQUESTING_CREDENTIALS" :connectionID="WalletConnectionID"
        @verifiable-credential-proof="displayProof" />
